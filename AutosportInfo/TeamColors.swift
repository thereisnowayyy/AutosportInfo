...
//  AutosportInfo
//
//  Created by Egor Salnikov on 26.09.2020.
...
extension UIColor {
    ...
    static let AlphaTauri = UIColor(red: 70 / 255, green: 155 / 255, blue: 255 / 255, alpha: 1)// RGBA(70, 155, 255, 1)
    ...
    static let ttt = UIColor(red: 128, green: 128, blue: 128, alpha: 1)
}
